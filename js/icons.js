...
(function () {
  ...
  var ICONS = {
    ...
    plans: S('<rect x="4" y="5.5" width="16" height="15" rx="2.5"/><path d="M4 9.5h16M8 3.5v3M16 3.5v3"/>'),
    plansFilled: S('<path d="M6 4h1V2.8h2V4h6V2.8h2V4h1a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Zm-1 6v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-9Z"/>', { fill:true }),
